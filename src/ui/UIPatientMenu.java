...
public class UIPatientMenu {
    ...
    private static void showBookAppointmentMenu(){
        ...
        do {
            ...
            System.out.println(new StringBuilder().append(doctorSelected.getName()).append(". Date: ").append(doctorSelected.getAvailableAppointments().get(indexDate).getDate()).append(". Time: ").append(doctorSelected.getAvailableAppointments().get(indexDate).getTime()).toString());
